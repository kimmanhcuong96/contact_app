...
class _AppShellState extends ConsumerState<AppShell> {
  int index = 0;
  static const screens = [ProfileScreen(), ConnectionsScreen(), QrScreen(), SettingsScreen()];
  @override Widget build(BuildContext context) { ref.watch(syncServiceProvider); ref.watch(notificationRegistrationProvider); return Scaffold(
